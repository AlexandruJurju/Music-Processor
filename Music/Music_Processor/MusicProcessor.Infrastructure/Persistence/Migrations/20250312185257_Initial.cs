        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    spotify_info_song_id = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    spotify_info_song_url = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    spotify_info_cover_url = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    spotify_info_album_id = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    spotify_info_artist_id = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ...
                    genre_category_id = table.Column<int>(type: "INTEGER", nullable: true),
                    date_created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    date_modified = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
