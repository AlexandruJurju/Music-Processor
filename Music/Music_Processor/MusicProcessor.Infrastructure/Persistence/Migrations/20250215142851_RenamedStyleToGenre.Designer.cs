...
namespace MusicProcessor.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250215142851_RenamedStyleToGenre")]
    partial class RenamedStyleToGenre
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("genre_styles", b =>
                {
                    ...
                    b.HasIndex("GenresId")
                        .HasDatabaseName("ix_genre_styles_genres_id");
            ...
            modelBuilder.Entity("genre_styles", b =>
                {
                    b.HasOne("MusicProcessor.Domain.Entities.GenreCategory", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_genre_styles_genres_genre_categories_id");
                    ...
                    b.HasOne("MusicProcessor.Domain.Entities.Genre", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_genre_styles_styles_genres_id");
                });
